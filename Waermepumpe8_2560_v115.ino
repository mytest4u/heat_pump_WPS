...
/*
  ...
  xxxxxxxx Test Version 1.115 xxxxxxxx
...
int maxcount = 1500; // max Laufzeit Verdichter wenn aktiv Sicherheitsabschaltung
...
void setup()   {
  ...
  display.println(" Stand: 25.11.2019");
    display.setCursor(0, 40);
  display.print(" Youtube => MyTest4u ");
     display.setCursor(0, 52);
  display.print(" Version 1.114 ");
  display.display();
...
//CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCelsius
void  TCelsius()  {
  int cthz=0;
  int ctww=0;
...
void  werte()  {
  ...
  if (zeitm > 9) {
    ...
    display.println("Anzahl VD Starts: "); 
    display.print(" nVD Hz: ");
    display.println(vdnhz);  // Anzahl VD Starts
    display.print(" nVD WW: ");
    display.println(vdnww);  // Anzahl VD Starts
       
    display.println("Max last Laufzeit:");
    display.print(" VD Hz: ");
    display.println(vdcountlasthz);  // max VD Laufzeit heizung
    display.print(" VD WW: ");
